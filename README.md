...
This homework uses **ParlGov** — a comparative dataset on political parties, elections, and governments in 37 democracies. The Excel file `parlgov.xlsx` contains three sheets you will work with:
